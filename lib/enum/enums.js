...
const STATUS_MESSAGES = {
  AGREE_INSTALL_PROJECT: 'Do you want to install the project?',
  ACTIVE_SKIPPED_FOLDER: 'The option of not generating folder has been activated',
  ...
  DIRECTORY_ALREADY_EXISTS_QUESTION:
    'The directory already exists, do you want to overwrite the directory and its contents?',
  ...
  DIRECTORY_OVERWRITTEN_ABORTED:
    'The folder overwrite process has been aborted by the user',
  ...
  STRUCTURE_GENERATED: 'The following structure has been generated:'
};
